...
import io.github.rypofalem.armorstandeditor.PlayerDisplayEditor;
...
//TODO rewrite for Display Entity
public class DisplayMenu {
    private final Inventory menuInv;
    private final PlayerDisplayEditor pe;
    private static String name = "Armor Stand Editor Menu";

    public DisplayMenu(PlayerDisplayEditor pe) {
        this.pe = pe;
